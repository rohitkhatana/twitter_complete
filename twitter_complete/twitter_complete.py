...
if __name__=="__main__":
    ...
    api = Api(consumer_key, consumer_secret,
              oauth_token, oauth_token_secret)
    ut1 =api.get_user_timeline(screen_name="thegooglefact")
    ut2 =api.get_user_timeline(screen_name="thegooglefact",max_id=391315434420842496)
    ut3 =api.get_user_timeline(screen_name="thegooglefact",max_id=390893088916639744)
    c=0
